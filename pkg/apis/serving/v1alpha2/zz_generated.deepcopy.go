...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenScoringSpec) DeepCopyInto(out *OpenScoringSpec) {
	*out = *in
	in.Resources.DeepCopyInto(&out.Resources)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenScoringSpec.
func (in *OpenScoringSpec) DeepCopy() *OpenScoringSpec {
	if in == nil {
		return nil
	}
	out := new(OpenScoringSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PredictorSpec) DeepCopyInto(out *PredictorSpec) {
	*out = *in
	...
	if in.OpenScoring != nil {
		in, out := &in.OpenScoring, &out.OpenScoring
		*out = new(OpenScoringSpec)
		(*in).DeepCopyInto(*out)
	}
	in.DeploymentSpec.DeepCopyInto(&out.DeploymentSpec)
...
func (in *PredictorsConfig) DeepCopyInto(out *PredictorsConfig) {
	*out = *in
	...
	out.ONNX = in.ONNX
	out.OpenScoring = in.OpenScoring
}
